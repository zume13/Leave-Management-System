...
{
    internal sealed class GetAllRequestsQueryHandler(
        IApplicationDbContext context)
        : IQueryHandler<GetAllRequestsQuery, List<GetAllRequestsDto>>
    {
        private readonly IApplicationDbContext _context = context;

        public async Task<ResultT<List<GetAllRequestsDto>>> Handle(
